...
public enum HandlerFactory {
    ...
    public PlayerMessageHandler createPlayerHandler(Object message, long playerId, IRecord record) {
    ...
    public <T extends IEvent> AbstractHandler createEventHandler(T event, IRecord record) {
