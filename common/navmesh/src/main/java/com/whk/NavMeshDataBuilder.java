...
import static com.whk.Main.DATA_DIR;

public enum NavMeshDataBuilder {
    INSTANCE;

    public NavMeshService buildNavMesh(String fileName) throws IOException {
        // 1. 解析 OBJ
    ...
    private NavMesh buildNavMesh(SimpleInputGeomProvider geom) {
